    ...
    return (
        <div className="space-y-6">
            ...
            <div>
                ...
                <p className="text-sm text-slate-500 mt-1">Platform-level management for Nostos staff</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <Link href="/super-admin-panel" className="block">
                    <div className="bg-white rounded-xl border border-amber-200 p-5 shadow-sm hover:shadow-md hover:border-amber-300 transition-all cursor-pointer group">
                        <div className="flex items-center gap-3 mb-3">
                            <div className="w-9 h-9 rounded-lg bg-amber-100 flex items-center justify-center shrink-0">
                                <svg className="w-5 h-5 text-amber-600" fill="none" stroke="currentColor" strokeWidth={1.6} viewBox="0 0 24 24">
                        ...
                        <div className="mt-3 pt-3 border-t border-slate-100 flex items-center justify-between">
                            <span className="text-xs text-amber-600 font-medium">Open panel →</span>
                        </div>
                    </div>
                </Link>
                ...
                <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
                    <div className="flex items-center gap-3 mb-3">
                        <div className="w-9 h-9 rounded-lg bg-slate-100 flex items-center justify-center shrink-0">
                            <svg className="w-5 h-5 text-slate-500" fill="none" stroke="currentColor" strokeWidth={1.6} viewBox="0 0 24 24">
                ...
                <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
                    <div className="flex items-center gap-3 mb-3">
                        ...
                        <div>
                            <p className="text-sm font-semibold text-slate-700">User Impersonation</p>
